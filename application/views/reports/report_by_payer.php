...
<div class="panel panel-default">
    ...
    <div class="panel-heading">Report By Payer</div>
    <div class="panel-body">
<div class="col-md-12 col-lg-12 col-sm-12 report-params">
<form id="payer-report" action="<?php echo site_url('Reports/reportByPayer/view') ?>">
...
<th>Type</th><th>Note</th><th>Payer</th>
...
$('#payer-report').on('submit',function(){
