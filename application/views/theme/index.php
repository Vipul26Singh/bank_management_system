...
<div class="row">
<div class="col-md-12 col-lg-12 col-sm-12 content-title"><h4><?php get_phrase('heading_dashboard') ?></h4></div>
<div class="jumbotron text-center">
  <h2>Welcome To People Development</h2>
  <h4><u><b><a style="color:#23c6c8" href="addMember">Create Memeber Here</a></b></u></h4> 
</div>
<div class="clo-md-3 col-lg-3 col-sm-6">
<div class="card-box">
    <div class="box-callout-green">
        <div class="rightside-cart">
            <p class="card-head"><?php get_phrase('current_day_income') ?><br>  
...
<div class="card-box">
    <div class="box-callout-orange">
        ...
        <div class="rightside-cart">
            <p class="card-head"><?php get_phrase('current_day_expense') ?><br>
...
<div class="card-box">
    <div class="box-callout-green">
        <div class="rightside-cart">
            <p class="card-head"><?php get_phrase('current_month_income') ?><br>
...
<div class="card-box">
    <div class="box-callout-orange">
        <div class="rightside-cart">
            <p class="card-head"><?php get_phrase('current_month_expense') ?><br>      
...
<div class="panel panel-default custom-box">
    ...
    <div class="panel-heading"><?php get_phrase('panel_income_vs_expense') ?> - <?php echo date("M Y") ?></div>
...
<div class="panel panel-default custom-box">
    <!-- Default panel contents -->
    <div class="panel-heading"><?php get_phrase('panel_latest_5_income') ?></div>
    <div class="panel-body">
        <!--Income Table-->
        <table class="table table-bordered">
            <th><?php get_phrase('date') ?></th>
            <th><?php get_phrase('description') ?></th>
            <th class="text-right"><?php get_phrase('amount') ?></th>
...
<div class="panel panel-default custom-box">
    <!-- Default panel contents -->
    <div class="panel-heading"><?php get_phrase('panel_latest_5_expense') ?></div>
    <div class="panel-body">
        <table class="table table-bordered">
            <th><?php get_phrase('date') ?></th>
            <th><?php get_phrase('description') ?></th>
...
<div class="panel panel-default medium-box">
    ...
    <div class="panel-heading"><?php get_phrase('panel_financial_balance_status') ?></div>
    <div class="panel-body financial-bal">
        <table class="table table-bordered ">
            <th><?php get_phrase('account') ?></th>
            <th class="text-right"><?php get_phrase('balance') ?></th>
...
//        xFormat: '%Y%m%d', // 'xFormat' can be used as custom format of 'x'
        columns: [
            ...
            <?php
            if(empty($line_chart[0])){
                $line_chart[0]=$line_chart[1];
            }

             for($i=1;$i<=count($line_chart[0]);$i++){
             echo ",";    
...
data: {
columns: [
["<?php get_phrase('income') ?>", <?php echo $pie_data['income'] ?>],
["<?php get_phrase('expense') ?>", <?php echo $pie_data['expense'] ?>],
],
type: 'donut',
...
donut: {
title: "<?php get_phrase('panel_income_vs_expense') ?>"
}
});
