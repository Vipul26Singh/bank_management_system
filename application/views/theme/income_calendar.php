...
<div class="col-md-12 col-lg-12 col-sm-12 content-title"><h4><?php get_phrase('heading_calendar') ?></h4></div>
<div class="col-md-10 col-lg-10 col-sm-10">
<!--Start Panel-->
<div class="panel panel-default">
    <!-- Default panel contents -->
    <div class="panel-heading"><?php get_phrase('panel_income_calendar') ?> <div class="add-button">
    <a class="mybtn btn-default asyn-link" href="<?php echo site_url('Admin/addIncome') ?>">
	<?php get_phrase('add_income') ?></a>
    </div></div>
