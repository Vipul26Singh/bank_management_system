	  ...
	  <td><?php echo $account->bank_account_number ?></td>
	    <td><?php echo $account->member_name ?></td>
         <td><?php echo $account->account_balance ?></td>
          <td><?php echo $account->bank_account_type ?></td>
           <td><?php echo $account->opening_date ?></td>  
        <td><a class="mybtn btn-info btn-xs account-edit-btn" href="<?php echo site_url('Admin/editAccount/'.$account->member_id) ?>"><i class="fa fa-search"></i> <?php get_phrase('view') ?></a>
        <?php if($account->status==1){?><a class="mybtn btn-danger btn-xs account-remove-btn" href="<?php echo site_url('Admin/addAccount/deactivate/'.$account->member_id) ?>"><i class="fa fa-trash-o"></i> <?php get_phrase('deactivate') ?></a><?php }?>
          <?php if($account->status==0){?><a class="mybtn btn-danger btn-xs account-remove-btn" href="<?php echo site_url('Admin/addAccount/activate/'.$account->member_id) ?>"><i class="fa fa-trash-o"></i> <?php get_phrase('activate') ?></a><?php }?></td>  
