...
defined('LOAN_SHORT_CODE')      OR define('LOAN_SHORT_CODE', 'loan');
defined('FD_SHORT_CODE')      OR define('FD_SHORT_CODE', 'fd');
defined('FD_WITHDRAW')      OR define('FD_WITHDRAW', 'Fixed deposit withdraw');
defined('FREQUENCY_ONETIME')      OR define('FREQUENCY_ONETIME', 'ONETIME');
defined('FREQUENCY_MONTHLY')      OR define('FREQUENCY_MONTHLY', 'MONTHLY');
defined('FREQUENCY_YEARLY')      OR define('FREQUENCY_YEARLY', 'YEARLY');
defined('SAVING_SHORT_CODE')      OR define('SAVING_SHORT_CODE', 'saving');
defined('LOAN_SHORT_CODE')      OR define('LOAN_SHORT_CODE', 'loan');
defined('CURRENT_SHORT_CODE')      OR define('CURRENT_SHORT_CODE', 'current');
defined('FD_SHORT_CODE')      OR define('FD_SHORT_CODE', 'fd');
defined('SERVICE_CHARGE_REMARKS')      OR define('SERVICE_CHARGE_REMARKS', 'Service Charge Deduction');
