...
<div class="panel panel-default">
    ...
    <div class="panel-heading">Date Wise Income Report</div>
    <div class="panel-body">
<div class="col-md-12 col-lg-12 col-sm-12 report-params">
<form id="income-report" action="<?php echo site_url('Reports/datewiseIncomeReport/view') ?>">
...
<div class="report-heading">
 <h4>Date Wise Income Report</h4>
 <p>Date From - - - - To - - - -</p>
</div>
<div id="Table-div">
<table class="table table-bordered">
<thead>
<th>Member Id</th><th>Date</th><th>Reference</th><th class="text-right">Amount</th><th>Note</th>
 <tbody>
...
$('#income-report').on('submit',function(){
