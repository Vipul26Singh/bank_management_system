...
<div class="col-md-12 col-lg-12 col-sm-12 content-title"><h4><?php get_phrase('heading_backup_database') ?></h4></div>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading"><?php get_phrase('panel_backup_database') ?></div>
    <div class="panel-body">

       <table class="table table-striped table-bordered table-condensed">
        <th><?php get_phrase('table_name') ?></th><th width="60"><?php get_phrase('backup') ?></th>
