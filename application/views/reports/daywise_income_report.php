...
<div class="panel panel-default">
    ...
    <div class="panel-heading">Day Wise Income Report</div>
    <div class="panel-body">
<div class="col-md-12 col-lg-12 col-sm-12 report-params">
<form id="income-report" action="<?php echo site_url('Reports/daywiseIncomeReport/view') ?>">
