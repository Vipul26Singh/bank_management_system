...
<div class="col-md-12 col-lg-12 col-sm-12 content-title"><h4><?php get_phrase('heading_edit_transaction') ?></h4></div>
...
<div class="panel panel-default">
 ...
 <div class="form-group"> 
    ...
    <option value="<?php echo $transaction->member_name ?>"><?php echo $transaction->member_name ?></option>  
    </select>      
  </div> 
 ...
 <div class="form-group">
    ...
    <div class='input-group date' id='date'>
        <input type='text' name="date" id="date" value="<?php echo $transaction->trans_date ?>" class="form-control" disabled/>
