...
<?php if(isset($accounts)){foreach ($accounts as $account) { ?>
	<tr>
		...
		<td><a class="mybtn btn-info btn-xs account-edit-btn" href="<?php echo site_url('Admin/manageAccount/view/'.$account['bank_account_number'].'/0') ?>"><i class="fa fa-search"></i> <?php get_phrase('view') ?></a>
		<a class="mybtn btn-danger btn-xs account-remove-btn" href="<?php echo site_url('Admin/manageAccount/activate/'.$account['bank_account_number']) ?>"><i class="fa fa-trash-o"></i> <?php get_phrase('activate') ?></a>
...
swal("Activated!", "Please change share if applicable", "success");  
window.setTimeout(function(){location.reload()},1000) 
$(".block-ui").css('display','none');
}
else{swal("Error!", "Unable to Activate", "error");  
window.setTimeout(function(){location.reload()},1000) 
$(".block-ui").css('display','none');}
}    
});
