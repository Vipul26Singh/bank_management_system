...
<div class="col-md-12 col-lg-12 col-sm-12 content-title"><h4><?php get_phrase('inactive_member') ?></h4></div>


<!--Alert-->
<div class="system-alert-box">

<div class="panel-heading"><?php get_phrase('manage_deactivated_member') ?> <div class="add-button">
...
<table class="table table-striped table-bordered table-hover" cellspacing="0" rules="all" border="1" id="ContentPlaceHolder1_GridView1" style="background-color:White;width:100%;">
	...
	<a class="mybtn btn-danger btn-xs account-remove-btn" href="<?php echo site_url('Admin/activateMember/'.$details->member_id) ?>"><i class="fa fa-trash-o"></i> <?php get_phrase('activate') ?></a>
