...
<div class="col-md-12 col-lg-12 col-sm-12 content-title"><h4><?php get_phrase('heading_chart_of_accounts') ?></h4></div>
...
<div class="panel panel-default">
    ...
    <div class="panel-heading"><?php get_phrase('panel_chart_of_accounts') ?></div>
    <div class="panel-body add-client">
    <form id="add-Chart-account">
 <input type="hidden" name="action" id="action" value="insert"/>  
 <input type="hidden" name="chart_id" id="chart_id" value=""/>    
 <div class="form-group"> 
    <label for="account"><?php get_phrase('category_name') ?></label>
    <input type="text" maxlength="30" class="form-control" name="account" id="account"/>   
  </div> 

        
  <div class="form-group"> 
    <label for="account-type"><?php get_phrase('account_type') ?></label>
    <select name="account-type" class="form-control" id="account-type"> 
    <option value="Income"><?php get_phrase('income') ?></option>
    <option value="Expense"><?php get_phrase('expense') ?></option> 
    </select>      
  </div>                       
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
       <table class="scroll-table-head table table-striped table-bordered">
        <th class="sc-col-4"><?php get_phrase('account_name') ?></th>
		<th class="sc-col-3"><?php get_phrase('account_type') ?></th>
       ...
       <?php foreach($accountList as $list){ ?>
        ...
        <td class="sc-col-3"><a class="mybtn btn-info btn-xs chart-edit-btn"  href="<?php echo $list->chart_id ?>"><?php get_phrase('edit') ?></a>
        <a class="mybtn btn-danger btn-xs chart-remove-btn"  href="<?php echo site_url('Admin/chartOfAccounts/remove/'.$list->chart_id) ?>"><?php get_phrase('remove') ?></a></td>     
        </tr>
...
var edit_link="<a class='mybtn btn-info btn-xs chart-edit-btn' href='"+id+"'><?php get_phrase('edit') ?></a>";
var remove_link="<a class='mybtn btn-danger btn-xs chart-remove-btn' href='"+base+"'><?php get_phrase('remove') ?></a>";
/*
