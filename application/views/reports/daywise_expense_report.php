...
<div class="panel panel-default">
    ...
    <div class="panel-heading">Day Wise Expense Report</div>
    <div class="panel-body">
<div class="col-md-12 col-lg-12 col-sm-12 report-params">
<form id="expense-report" action="<?php echo site_url('Reports/daywiseExpenseReport/view') ?>">
