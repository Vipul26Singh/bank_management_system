...
<div class="panel panel-default">
    ...
    <div class="panel-heading">Transfer Report</div>
    <div class="panel-body">
<div class="col-md-12 col-lg-12 col-sm-12 report-params">
<form id="transfer-report" action="<?php echo site_url('Reports/transferReport/view') ?>">
...
<thead>
<th>Date</th><th>Reference</th><th>Note</th><th class="text-right">Dr</th><th class="text-right">Cr</th>
 <tbody>
