...
<div class="panel panel-default">
    ...
    <div class="panel-heading">Report By Chart Of Accounts</div>
    <div class="panel-body">
<div class="col-md-12 col-lg-12 col-sm-12 report-params">
<form id="category-report" action="<?php echo site_url('Reports/incomeCategoryReport/view') ?>">
...
<option value="<?php echo $account->accounts_name ?>"><?php echo $account->accounts_name ?> (Type : <?php echo $account->accounts_type ?>)</option>
<?php } ?>
</select>
</div> 
</div>
...
<div class="report-heading">
 <h4>Report By Chart Of Accounts</h4>
 <p>Date From - - - - To - - - -</p>
</div>
<div id="Table-div">
<table class="table table-bordered">
<thead>
<th>Date</th><th>Account</th><th>Category</th><th>Type</th><th>Note</th>
...
$('#category-report').on('submit',function(){
