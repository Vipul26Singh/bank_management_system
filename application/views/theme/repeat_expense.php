...
<div class="col-md-12 col-lg-12 col-sm-12 content-title"><h4><?php get_phrase('heading_repeating_expense') ?></h4></div>
...
<div class="col-md-6 col-lg-6 col-sm-6"> 
  <div class="form-group">
    <label for="rotation-expense"><?php get_phrase('number_of_rotation') ?> (<?php get_phrase('payment') ?>)</label>
    <input type="text" class="form-control" name="rotation-expense" id="rotation-expense">
  </div>  
</div>
  
   <div class="col-md-6 col-lg-6 col-sm-6">                   
  <div class="form-group"> 
    <label for="expense-type"><?php get_phrase('expense_type') ?></label>
...
$(".asyn-repeat-expense").addClass("active-menu"); 

$("#rotation-expense").keypress(function (e) {
...
$('#add-repeat-expense').on('submit',function(event){ 
$.ajax({
method : "POST",
url : "<?php echo site_url('Admin/repeatExpense/insert') ?>",
data : $(this).serialize(),
beforeSend : function(){
